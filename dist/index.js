...
var s3Params = {
    ...
    Key: _config2.default.s3.filePath
};

var awsHelper = {
    getS3Data: function () {
        var _ref = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee() {
            var jsonDataOutside, response;
            return _regenerator2.default.wrap(function _callee$(_context) {
                while (1) {
                    switch (_context.prev = _context.next) {
                        case 0:
                            jsonDataOutside = {};
                            response = s3.getObject(s3Params, function (err, data) {
                                if (err) {
                            ...
                            return response.promise().then(function (data) {
                                var jsonData = JSON.parse(new Buffer(data.Body).toString("utf8"));
                                jsonDataOutside = jsonData;
                            });

                        case 4:
                            return _context.abrupt('return', jsonDataOutside);
    ...
    return _regenerator2.default.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.next = 2;
            return _aws2.default.getS3Data();
...
var _aws = __webpack_require__(/*! ./aws */ "./src/aws.js");
